...
//The problem is that your code refers to Player which is the name of the constructor or class. But you don't want this code to act on the class, you want it to act on the instance of the class that calls the method, and you can refer to the instance as this. e.g.

//if (allEnemies[i].x < this.x + 171 && allEnemies[i].x + 171 > this.x &&
